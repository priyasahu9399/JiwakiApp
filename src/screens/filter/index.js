  ...
  return (
    <View>
      <TouchableOpacity
        ...
        <Image source={icons.R_arrow} style={styles.arrow} />
    ...
    <View style={styles.container}>
          ...
          <View style={styles.heightborder}>
            <TouchableOpacity
              ...
              style={[
                ...
                active === 'Categories' && styles.activebg
              ]}>
            ...
            <TouchableOpacity
              ...
              style={[
                styles.categoriesbox,
                active === 'Discount' && styles.activebg
              ]}>
      ...
      <View>
        <View style={styles.rowbtn}>
          <Button mediumbtn children="Reset" whitebgbtn />
